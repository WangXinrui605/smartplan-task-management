...
class Task(models.Model):
    ...
    category = models.ForeignKey(Category, on_delete=models.SET_NULL, null=True)  # 关联分类
    priority = models.ForeignKey(Priority, on_delete=models.SET_NULL, null=True)  # 关联优先级
